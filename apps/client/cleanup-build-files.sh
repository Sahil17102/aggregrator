...
# Script to remove build files from choicemee-client root directory
...
VPS_TARGET_PATH="/var/www/choicemee/choicemee-client"
...
echo "ðŸ§¹ Cleaning up build files from choicemee-client root directory"
